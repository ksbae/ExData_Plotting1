...
lines(c(1200, 1500), c(36, 36), col="black")
text(1600, 36, "Sub_mertering_1", cex=0.85, pos=4)
lines(c(1200, 1500), c(32, 32), col="red")
text(1600, 32, "Sub_mertering_2", cex=0.85, pos=4)
lines(c(1200, 1500), c(28, 28), col="blue")
text(1600, 28, "Sub_mertering_3", cex=0.85, pos=4)
axis(1, at=c(1, Len/2, Len), labels=c("Thu","Fri","Sat"))
